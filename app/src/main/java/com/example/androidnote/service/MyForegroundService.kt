...
class MyForegroundService : Service() {
    ...
    private fun updateProgres(
        @androidx.annotation.IntRange(from = 0L , to = 100L) progress: Int) {
        notificationManager.notify(NOTIFICATION_DOWNLOAD_ID, createDownloadingNotification(progress))
    }

    private fun createDownloadingNotification(@androidx.annotation.IntRange(from = 0L , to = 100L) progress: Int) =
